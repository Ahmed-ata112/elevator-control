...
add wave -noupdate /resolver_fsm_tb/resolver_fsm_inst/buttons_r
add wave -noupdate /resolver_fsm_tb/resolver_fsm_inst/ups_r
add wave -noupdate /resolver_fsm_tb/resolver_fsm_inst/downs_r
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {12869 ns} 0} {{Cursor 2} {16722 ns} 0} {{Cursor 3} {12839 ns} 0}
...
update
WaveRestoreZoom {16704 ns} {16786 ns}
